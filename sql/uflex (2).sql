...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2020 at 04:16 PM
...
--
-- Table structure for table `london_sold_stock`
--

CREATE TABLE `london_sold_stock` (
  `id` int(11) NOT NULL,
  ...
  `last_upate` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `london_sold_stock`
--

INSERT INTO `london_sold_stock` (`id`, `batch_number`, `invoice_number`, `item_code`, `item_details`, `sold_qty`, `rate`, `amount`, `invoice_date`, `updated_by`, `last_upate`) VALUES
(8, '2020-05-30', '22/2015', 'YELG500V4', 'TILDA EASY COOK LONG GRAN 500G', 200, 0, 0, '0000-00-00', 'London- outlet ', '2020-06-08'),
(9, '2020-05-30', '20', 'YELG500V4', 'TILDA EASY COOK LONG GRAN 500G', 50, 2, 0, '0000-00-00', 'London- outlet ', '2020-06-08'),
(10, '2020-05-30', '', 'YELG500V4', 'TILDA EASY COOK LONG GRAN 500G', 50, 0, 0, '0000-00-00', 'London- outlet ', '2020-06-08'),
(11, '2020-05-30', 'INV270520200001', 'YELG500V4', 'TILDA EASY COOK LONG GRAN 500G', 50, 0, 0, '2020-07-02', 'London- outlet ', '2020-06-08');
...
INSERT INTO `london_stock` (`id`, `invoice_number`, `item_code`, `item_description`, `qty`, `amount`, `rate`, `update_by`, `last_updated`, `closing_stock`, `last_closing`, `invoice_date`) VALUES
(49, 'INVC200202106', 'YLG500V4', 'TILDA LONG GRAN 500G', 200, 6000, 30, 'London- outlet ', '2020-06-05 15:28:09', 0, '0000-00-00', '2020-05-28'),
(50, 'INVC200202104', 'YLG500V5', 'TILDA LONG GRAN 500G', 200, 6000, 30, 'London- outlet ', '2020-06-05 15:28:09', 0, '0000-00-00', '2020-05-31'),
(51, 'INVC200202100', 'YLG500V4', 'TILDA LONG GRAN 500G', 500, 2000, 40, 'London- outlet ', '2020-06-05 16:18:36', 0, '0000-00-00', '2020-05-28'),
(52, 'INVC200202103', 'YELG500V4', 'TILDA EASY COOK LONG GRAN 500G', 200, 14000, 70, 'London- outlet ', '2020-06-08 10:21:45', 150, '2020-06-08', '2020-05-30'),
(53, 'INVC200202104', 'YLG500V4', 'TILDA LONG GRAN 200G', 200, 6000, 30, 'London- outlet ', '2020-06-08 10:21:49', 0, '0000-00-00', '2020-05-31');
...
--
-- Indexes for table `london_sold_stock`
--
