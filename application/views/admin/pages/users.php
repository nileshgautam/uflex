                    ...
                    <div class="row container">
                        ...
                        <div class="form-group col-md-4 gender-resize">
                            ...
                            <label class="radio-inline">
                                ...
                                <input type="radio" value="male" class="form-control rs-22" name="gender" checked> Male 
                            </label>
                            <label class="radio-inline">
                                <input type="radio" value="female" class="form-control rs-22" name="gender"> Female
                            </label>
                            <label class="radio-inline">
                                <input type="radio" value="other" class="form-control rs-22" name="gender"> Other
                            </label>
                        </div>

                        <div class="form-group col-md-4">
                            <label for="last-name">Date of Birth<span class="text-danger">*</span></label>
                            <input type="date" class="date form-control" value="<?php echo (isset($users)) ? mdy($users[0]['dob']) : "" ?> "
                            name="dob" id="">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="last-name">Joining  Date<span class="text-danger">*</span></label>
                            <input type="date" class="date form-control" value="<?php echo (isset($users)) ? mdy($users[0]['joining_date']) : "" ?> " name="doj" id="">
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group" id="show_hide_password">
                                <input id="cnf-password" type="password" name="confirm-password" placeholder="Re-enter password." autocomplete="off" class="form-control" value="<?php echo (isset($users)) ? $users[0]['password'] : "" ?>" required>
                                <div class="input-group-addon">
                                    <a href='#'><i class="fa fa-eye-slash" aria-hidden="true" style="padding: 10px; border: 1px solid #d3cfcf;"></i></a>
                                </div>
                            </div>
...
<!-- button section -->
                    <div class="user-btn">
                        ...
                        <button type="" class="btn btn-space btn-warning btn-xs " id="back-to-users">Back</button>
                    </div>
                </form>
            </div>
        </div>
