    ...
    <div class="container dashboard-content">
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?php echo base_url('manager') ?>" class="btn btn-warning btn-circle btn-invoice" title="Back">
                ...
                <form id="change-password" method="post">
                    <div class="box">
                        ...
                        <div class="user-btn col-md-12">
                            ...
                            <a href="<?php echo base_url('manager') ?>" class="btn btn-space btn-warning btn-xs" title="Back">
                                Back
                            </a>
